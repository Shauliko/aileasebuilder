      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Generate a legally-compliant, state-specific residential lease instantly. Preview your lease free, then unlock the full document for $14.95.",
            provider: {
              "@type": "Organization",
            ...
            offers: {
              ...
              priceCurrency: "USD",
              description:
                "Preview your lease free. Unlock the full document for $14.95.",
            },
          }),
        }}
      />
      ...
      <div className="max-w-4xl mx-auto">
        <header className="mb-6">
          ...
          <p className="text-gray-300">
            Preview your lease instantly for free. Unlock the full document for $14.95.
          </p>
        </header>
    ...
    <section className="space-y-8">
      ...
      <div className="text-xs text-gray-400 border border-white/10 rounded-xl p-4 bg-[#050816]/40">
        <p className="mb-1">
          ...
          state-compliant lease, and prepare a preview for you to review before
          purchasing the full document.
        </p>
      </div>
    </section>
  );
    ...
    <div className="border border-white/10 rounded-xl p-4 bg-[#050816]/60 space-y-3">
      <label className="flex items-center gap-3 cursor-pointer">
        ...
        <span className="text-sm font-medium">
          Include multilingual versions (add-on after purchase)
        </span>
      </label>
