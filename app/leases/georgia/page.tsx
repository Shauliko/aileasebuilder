...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "georgia")!;
...
export const metadata: Metadata = {
  ...
  description: `Create a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant law. Lawyer-grade, AI-built, enforceable.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName}-compliant residential lease in minutes.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description:`AI-generated ${stateName} residential lease compliant with ${stateName} law.`,
  ...
  return (
    <>
      <Script id="ga-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="ga-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
