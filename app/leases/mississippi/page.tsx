...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "mississippi")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific lease aligned with state rental laws. Lawyer-grade, AI-powered.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `${stateName} residential lease compliant with state law.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description: `${stateName} AI-generated residential lease for landlords and property managers.`,
  ...
  return (
    <>
      <Script id="ms-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="ms-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
