...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "iowa")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-specific, lawyer-grade residential lease aligned with ${stateName} landlord–tenant law.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create a ${stateName}-compliant lease using AI Lease Builder.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate your ${stateName} lease in minutes with AI.`,
  },
};
...
export default function Page() {
  ...
  return (
    <>
      ...
      <Script id="ia-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(breadcrumbs) }} />
