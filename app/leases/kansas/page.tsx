...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "kansas")!;
...
export const metadata: Metadata = {
  ...
  description:`Create a ${stateName}-compliant residential lease aligned with ${stateName} landlord–tenant law.`,
...
export default function Page() {
  const jsonLd = {
    ...
    description:`AI-generated lease tailored to ${stateName} landlord–tenant laws.`,
  ...
  return (
    <>
      <Script id="ks-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(jsonLd) }} />
      <Script id="ks-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(breadcrumbs) }} />
