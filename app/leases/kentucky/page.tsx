...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "kentucky")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-compliant residential lease following ${stateName} landlord–tenant statutes.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`AI Lease Builder generates ${stateName} leases in minutes.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Build your ${stateName} lease with AI.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description:`AI-created ${stateName} residential lease compliant with state law.`,
  ...
  return (
    <>
      <Script id="ky-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(jsonLd) }} />
      <Script id="ky-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(breadcrumbs) }} />
