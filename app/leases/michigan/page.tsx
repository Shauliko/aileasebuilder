...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "michigan")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-compliant residential lease tailored to ${stateName} landlord–tenant guidelines.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create an AI-generated ${stateName} lease aligned with rental laws.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description: `${stateName} lawyer-style residential lease generated by AI.`,
  ...
  return (
    <>
      <Script id="mi-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="mi-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
