...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "new-hampshire")!;
...
export const metadata: Metadata = {
  ...
  description: `Create a ${stateName}-specific residential lease that follows ${stateName} landlord–tenant statutes. Lawyer-style, AI-generated.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName}-compliant lease in minutes with AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate your ${stateName} lease using AI.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated ${stateName} residential lease aligned with local law.`,
  ...
  return (
    <>
      <Script id="nh-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="nh-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
