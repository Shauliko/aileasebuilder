...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "indiana")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate an ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant laws. Lawyer-grade, AI-generated, and ready to sign.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create an ${stateName}-compliant residential lease in minutes with AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated ${stateName} residential lease that reflects ${stateName} notice, deposit, and eviction rules.`,
  ...
  // Option 3: 2 neighbors + 2 high-value states
  const relatedStates = [
