...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "minnesota")!;
...
export const metadata: Metadata = {
  ...
  description: `Create a ${stateName}-compliant residential lease aligned with state rental laws.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `${stateName} lawyer-style rental contract generated by AI.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-tailored ${stateName} residential lease.`,
  ...
  return (
    <>
      <Script id="mn-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="mn-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
