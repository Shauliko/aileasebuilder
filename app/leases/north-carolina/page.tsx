...
const CONFIG = STATE_CONFIGS.find(s=>s.slug==="north-carolina")!;
...
export const metadata:Metadata={
  ...
  description:`Create a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant statutes. Lawyer-grade and AI-built.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate a state-compliant NC lease in minutes.`,
    url:pageUrl,
    type:"article"
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate a ${stateName} rental lease instantly.`,
  }
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`AI-crafted ${stateName} residential lease.`,
  ...
  return(
    <>
      <Script id="nc-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="nc-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
