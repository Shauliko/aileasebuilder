...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "hawaii")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant laws.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create a ${stateName}-compliant lease with AI Lease Builder.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate a ${stateName} residential lease in minutes.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description:`AI-generated, ${stateName}-compliant residential lease.`,
  ...
  const relatedStates = [
    { slug:"california", label:"California" }, // closest mainland
  ...
  return (
    <>
      <Script id="hi-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(jsonLd) }}/>
      <Script id="hi-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(breadcrumbs) }}/>
