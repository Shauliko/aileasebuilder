...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="south-carolina")!;
...
export const metadata:Metadata={
  ...
  description:`Generate a ${stateName}-specific rental lease following ${stateName} landlord–tenant law.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create an AI-generated ${stateName} residential lease.`,
    url:pageUrl,
    type:"article"
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Build your ${stateName} lease using AI.`,
  }
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`AI-crafted ${stateName} rental contract.`,
  ...
  return(
    <>
      <Script id="sc-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="sc-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
