...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "vermont")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease that reflects ${stateName} landlord–tenant law. Lawyer-grade, AI-generated, and state-compliant.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create a ${stateName} residential lease aligned with ${stateName} rental rules using AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-crafted ${stateName} residential lease tuned to local deposit, notice, and disclosure requirements.`,
