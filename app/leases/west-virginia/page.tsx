...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="west-virginia")!;
...
export const metadata:Metadata={
  ...
  description:`Generate a West Virginia residential lease aligned with WV rental law. AI-built and fully compliant.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create a WV rental lease instantly with AI Lease Builder.`,
    url:pageUrl,
    type:"article"
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate your WV lease in minutes.`,
  }
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`AI-generated ${stateName} lease aligned with state law.`,
  ...
  return(
    <>
      <Script id="wv-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="wv-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
