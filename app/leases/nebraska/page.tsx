...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "nebraska")!;
...
export const metadata: Metadata = {
  ...
  description: `Create a ${stateName}-compliant residential lease aligned with ${stateName} landlord–tenant law. AI-built and lawyer-style.`,
  ...
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate your ${stateName} lease in minutes using AI.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `State-specific ${stateName} residential lease generated by AI.`,
  ...
  return (
    <>
      <Script id="ne-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="ne-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
