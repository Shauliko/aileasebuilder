...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "maryland")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant law. Lawyer-grade, AI-built, and enforceable.`,
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated ${stateName} residential lease that reflects ${stateName} notice periods, deposit limits, and disclosure rules.`,
