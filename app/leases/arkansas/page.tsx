...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "arkansas")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant rules. AI-built, lawyer-grade, fully state-compliant.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create a ${stateName} rental lease that follows ${stateName} landlord–tenant law.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName}-compliant residential lease with the AI Lease Builder.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated residential lease tailored to ${stateName} landlord–tenant law.`,
  ...
  return (
    <>
      <Script id="arkansas-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="arkansas-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
