...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "arizona")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease agreement that reflects ${stateName} landlord–tenant rules. Lawyer-grade rental contract for landlords and property managers.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement (${abbreviation})`,
    description: `Create a ${stateName} residential lease aligned with ${stateName} landlord–tenant law using AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement (${abbreviation})`,
    description: `Generate a ${stateName}-compliant residential lease in minutes with AI Lease Builder.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated ${stateName} residential lease tuned to ${stateName} landlord–tenant law.`,
  ...
  return (
    <>
      <Script
        id="lease-legalservice-jsonld-az"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }}
      />
      <Script
        id="breadcrumbs-jsonld-az"
        type="application/ld+json"
