...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="rhode-island")!;
...
export const metadata:Metadata={
  ...
  openGraph:{
    ...
    description:`AI-built ${stateName} residential lease.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate your ${stateName} lease now.`,
  },
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`State-compliant ${stateName} rental contract generated by AI.`,
  ...
  return(
    <>
      <Script id="ri-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="ri-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
