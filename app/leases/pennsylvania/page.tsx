...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="pennsylvania")!;
...
export const metadata:Metadata={
  ...
  description:`Generate a ${stateName}-specific residential lease that complies with ${stateName} landlord–tenant law.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`AI-generated ${stateName} rental contract.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Create your ${stateName} lease in minutes.`,
  },
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`AI-crafted, ${stateName}-compliant lease.`,
  ...
  return(
    <>
      <Script id="pa-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="pa-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
