...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "new-york")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-specific residential lease following NY landlord–tenant law. Lawyer-grade, compliant, AI-built.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create a state-compliant NY lease instantly.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate a NY lease in minutes with AI.`,
  },
};
...
export default function Page() {
  const jsonLd={
    ...
    description:`AI-generated ${stateName} rental lease aligned with state law.`,
  ...
  return (
    <>
      <Script id="ny-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}} />
      <Script id="ny-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}} />
