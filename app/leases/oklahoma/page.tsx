...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "oklahoma")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-compliant residential lease aligned with ${stateName} landlord–tenant rules. Lawyer-grade and AI-produced.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create a ${stateName}-specific residential lease in minutes with AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  const jsonLd = {
    ...
    description:`State-specific ${stateName} lease generated by AI.`,
  ...
  return (
    <>
      <Script id="ok-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}} />
      <Script id="ok-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}} />

      <section className="mb-10 space-y-3 text-sm">
        <a href="/leases" className="text-emerald-400 underline-offset-2 hover:underline">
          ← Back to All States
        </a>
