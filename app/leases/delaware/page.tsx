...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "delaware")!;
...
export const metadata: Metadata = {
  ...
  description: `Create a ${stateName}-compliant residential lease. AI-powered, lawyer-grade, aligned with ${stateName} landlord–tenant laws.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName} residential lease aligned with local rental laws.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Build a ${stateName}-compliant lease instantly with AI Lease Builder.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `State-specific ${stateName} residential lease created using AI.`,
  ...
  return (
    <>
      <Script id="delaware-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="delaware-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
