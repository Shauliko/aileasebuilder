...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="north-dakota")!;
...
export const metadata:Metadata={
  ...
  description:`Generate a ${stateName}-specific residential lease compliant with ${stateName} rental laws.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create an AI-generated ${stateName} lease.`,
    url:pageUrl,
    type:"article"
  },
  twitter:{
...
export default function Page(){
  const jsonLd={
    ...
    description:`State-specific ${stateName} lease drafted using AI.`,
  ...
  return(
    <>
      <Script id="nd-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="nd-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
