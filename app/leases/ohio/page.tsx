...
const CONFIG=STATE_CONFIGS.find(s=>s.slug==="ohio")!;
...
export const metadata:Metadata={
  ...
  description:`Generate a ${stateName}-specific residential lease compliant with ${stateName} rental law.`,
  alternates:{canonical:pageUrl},
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create an AI-generated ${stateName} lease aligned with state law.`,
    url:pageUrl,
    type:"article"
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate a ${stateName} lease instantly.`,
  }
};
...
export default function Page(){
  const jsonLd={
    ...
    description:`AI-crafted ${stateName} residential lease, lawyer-grade and compliant.`,
  ...
  return(
    <>
      <Script id="oh-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
      <Script id="oh-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}}/>
