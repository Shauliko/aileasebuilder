...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "california")!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `Create a state-compliant ${stateName} residential lease. AI generates a lawyer-style rental agreement aligned with ${stateName} landlord–tenant rules.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
...
export default function Page() {
  ...
  // Option 3 (Hybrid): 2 neighbors + 2 top states
  const relatedStates = [
    { slug: "nevada", label: "Nevada" }, // neighbor
    { slug: "arizona", label: "Arizona" }, // neighbor
    { slug: "texas", label: "Texas" }, // high-value
  ...
  return (
    <>
      ...
      <Script
        id="lease-legalservice-jsonld-ca"
