...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "massachusetts")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease that follows ${stateName} landlord–tenant statutes. Lawyer-grade and AI-built.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create a ${stateName}-compliant residential lease with AI Lease Builder.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName} rental lease in minutes.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated residential lease aligned with ${stateName} landlord–tenant laws.`,
  ...
  return (
    <>
      <Script id="ma-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="ma-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
