...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "colorado")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-compliant residential lease. AI-built, lawyer-grade, aligned with ${stateName} rental laws.`,
  alternates: { canonical: pageUrl },
  openGraph: {
    title: `${stateName} Residential Lease Agreement`,
    description: `Create a ${stateName} residential lease that follows ${stateName} landlord–tenant rules.`,
    url: pageUrl,
    type: "article",
  },
  twitter: {
    ...
    title: `${stateName} Residential Lease Agreement`,
    description: `Generate a ${stateName} residential lease with AI Lease Builder.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-crafted residential lease aligned with ${stateName} landlord–tenant laws.`,
  ...
  return (
    <>
      <Script id="colorado-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <Script id="colorado-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbs) }} />
