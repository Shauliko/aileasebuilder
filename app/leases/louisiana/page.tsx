...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "louisiana")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-compliant residential lease following ${stateName} rental laws.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`AI-generated ${stateName} residential lease.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
    ...
    title:`${stateName} Residential Lease Agreement`,
    description:`Generate your ${stateName} lease in minutes.`,
  },
};
...
export default function Page() {
  const jsonLd = {
    ...
    description:`AI-built residential lease aligned with ${stateName} law.`,
  ...
  return (
    <>
      <Script id="la-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(jsonLd) }} />
      <Script id="la-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{ __html:JSON.stringify(breadcrumbs) }} />
