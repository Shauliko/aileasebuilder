...
const CONFIG = STATE_CONFIGS.find((s) => s.slug === "tennessee")!;
...
export const metadata: Metadata = {
  ...
  description: `Generate a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant law. Lawyer-grade, AI-generated, and ready to sign.`,
...
export default function Page() {
  const jsonLd = {
    ...
    description: `AI-generated ${stateName} residential lease that reflects ${stateName} rental laws and notice rules.`,
