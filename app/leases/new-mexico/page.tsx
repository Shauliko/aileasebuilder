...
const CONFIG = STATE_CONFIGS.find(s => s.slug === "new-mexico")!;
...
export const metadata: Metadata = {
  ...
  description:`Generate a ${stateName}-specific residential lease aligned with ${stateName} landlord–tenant rules. AI-built and lawyer-grade.`,
  alternates:{ canonical:pageUrl },
  openGraph:{
    title:`${stateName} Residential Lease Agreement`,
    description:`Create a ${stateName}-compliant rental lease in minutes with AI.`,
    url:pageUrl,
    type:"article",
  },
  twitter:{
...
export default function Page() {
  const jsonLd={
    ...
    description:`Lawyer-style ${stateName} lease generated by AI.`,
  ...
  return (
    <>
      <Script id="nm-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}} />
      <Script id="nm-breadcrumbs" type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(breadcrumbs)}} />
